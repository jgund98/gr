  ...
  return (
    <article id={p.slug} className="scroll-mt-28">
      ...
      <Reveal delay={0.08} className="mt-7">
        ...
        {strip.length > 0 && (
          <div
            className="mt-3 flex snap-x snap-mandatory gap-3 overflow-x-auto pb-2 [-webkit-overflow-scrolling:touch] [scrollbar-width:thin] [scrollbar-color:rgba(136,192,71,0.4)_transparent]"
            role="group"
